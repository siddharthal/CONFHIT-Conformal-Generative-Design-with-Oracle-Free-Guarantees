...
from design import design_test, sample_and_prepare_test_data
...
def main(args):
    ...
    print("Running design for each input molecule...")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Design for Molecule Generation")
